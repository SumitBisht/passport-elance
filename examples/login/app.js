...
var ELANCE_CLIENT_ID = "--insert-elance-client-id-here--"
var Elance_CLIENT_SECRET = "--insert-elance-client-secret-here--";
...
passport.use(new ElanceStrategy({
    ...
    callbackURL: "--Insert application callback as provided by elance here--"
  },
